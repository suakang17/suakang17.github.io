...
7. [css inherit되는 속성들](https://www.impressivewebs.com/inherit-value-css/)
...
```
 ...
 3. Matched leaf route at location "/" does not have an element 콘솔 에러
...
```
 ...
 [출처](https://stackoverflow.com/questions/69854011/matched-leaf-route-at-location-does-not-have-an-element)
...
- Link tag vs a tag 
    + The path in your anchor tag is a relative path while that one in the Link is absolute(17년도글임) [출처](https://stackoverflow.com/questions/43087007/react-link-vs-a-tag-and-arrow-function)
